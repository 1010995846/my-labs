...
import cn.cidea.framework.mq.redis.config.CIdeaRedisMQCoreAutoConfiguration;
...
public class RedisMQTemplate {
    ...
    /**
     * pub
     * 监听器sub {@link CIdeaRedisMQCoreAutoConfiguration.PubSubAutoConfiguration#PubSubAutoConfiguration(RedissonClient, List)}
     * @param message
     */
