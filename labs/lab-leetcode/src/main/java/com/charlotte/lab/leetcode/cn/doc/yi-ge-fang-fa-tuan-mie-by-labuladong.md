...
经常刷 LeetCode 的读者肯定知道鼎鼎有名的 `twoSum` 问题，我们上篇文章 [twoSum 问题的核心思想](https://labuladong.gitbook.io/algo) 就对 `twoSum` 的几个变种做了解析。
...
我们可以先对 `nums` 排序，然后利用前文 [双指针技巧](https://labuladong.gitbook.io/algo) 写过的左右双指针技巧，从两端相向而行就行了：
...
![](https://pic.leetcode-cn.com/1598147821-nnZDiG-1.jpeg)
...
![](https://pic.leetcode-cn.com/1598147819-gOOLkn-title2.jpg)
...
![](https://pic.leetcode-cn.com/1598147820-NTBFlz-title3.jpg)
...
![目录](https://pic.leetcode-cn.com/1598147821-UpTUIj-table_qr3.jpg)