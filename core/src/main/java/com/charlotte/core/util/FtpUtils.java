...
public class FtpUtils {
    ...
    public FtpUtils(String controlEncoding) {
        ftp = new FTPClient();
...
//            fi.setType(ftpFile.isDirectory());
    ...
    public static void main(String[] args) throws Exception {
        FtpUtils ftpUtils = new FtpUtils("UTF-8");
        ftpUtils.connect("192.168.2.218", 21, "admin", "admin123");
        //ftpUtil.setTimeOut(60, 60, 60);
//        ftpUtil.upload("/home/testuser/文件1.txt", new File("E:/image/FTPClient/FTPClient测试/文件1.txt"));
        ftpUtils.download("/开/关.csv", new File("./org.csv"));
