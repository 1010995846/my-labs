...
import cn.cidea.module.pay.dataobject.enums.PayOrderDisplayModeEnum;
...
public class PayOrderRespDTO {
    ...
    public static PayOrderRespDTO waitingOf(String displayMode, String displayContent,
        ...
        respDTO.status = PayOrderStatusEnum.WAITING;
    ...
    public static PayOrderRespDTO successOf(String channelOrderNo, String channelUserId, LocalDateTime successTime,
                                            String outTradeNo, Object rawData) {
        PayOrderRespDTO respDTO = new PayOrderRespDTO();
        respDTO.status = PayOrderStatusEnum.SUCCESS;
     ...
     */
    public static PayOrderRespDTO of(PayOrderStatusEnum status, String channelOrderNo, String channelUserId, LocalDateTime successTime,
                                     String outTradeNo, Object rawData) {
        PayOrderRespDTO respDTO = new PayOrderRespDTO();
