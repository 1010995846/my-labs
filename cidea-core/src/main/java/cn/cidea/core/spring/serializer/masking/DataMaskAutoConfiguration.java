...
import cn.cidea.core.spring.serializer.masking.fastjson.DataMaskingFilter;
import cn.cidea.core.spring.serializer.masking.jackson.DataMaskingAnnotationIntrospector;
...
public class DataMaskAutoConfiguration {
    ...
    static class JacksonObjectMapperConfiguration {
        ...
        JacksonObjectMapperConfiguration(ObjectMapper objectMapper) {
            ...
            introspector = AnnotationIntrospectorPair.pair(introspector, new DataMaskingAnnotationIntrospector());
    ...
    static class FastJsonConfiguration {
        ...
        public FastJsonConfiguration(FastJsonHttpMessageConverter converter) {
            ...
            filters[filters.length - 1] = new DataMaskingFilter();
